...
class Gopro(data.Dataset):
    ...
    def get_img_pair(self, idx):
        ...
        return img_input, img_target,blur_file_path

    def __getitem__(self, idx):
        img_input, img_target,blur_file_path = self.get_img_pair(idx)
